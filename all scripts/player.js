...
currentTimeLabel.style.fontSize = "15px";
currentTimeLabel.style.fontFamily = "Gilroy";
currentTimeLabel.textContent = "0:00";
currentTimeLabel.style.position = "absolute";
currentTimeLabel.style.top = "380px";
currentTimeLabel.style.left = "25px";
currentTimeLabel.style.opacity = "0.5";
...
playerPlay.style.backgroundColor = "rgba(62, 62, 62, 1)";
...
// var currentTime = 0; // Текущее время воспроизведения (в секундах)
var duration = 100; // Общая продолжительность (в секундах)
