...
playerNext.style.right = "50px";
playerNext.style.top = "420px";
...
// Получаем текущее время в 12-часовом формате без секунд
const formattedTime = currentTime1.toLocaleTimeString(undefined, {
  hour: "numeric",
  minute: "numeric",
  hour12: true,
});
